...
describe('ForgotPasswordPage', () => {
  ...
  describe('Phase 2 — Code and new password', () => {
    ...
    it('shows error when code is not exactly 6 digits', async () => {
      ...
      await user.type(newPassInput(), 'NewPassword12!')
      await user.type(confirmInput(), 'NewPassword12!')
    ...
    it('shows error when passwords do not match', async () => {
      ...
      await user.type(codeInput(), '123456')
      await user.type(newPassInput(), 'NewPassword12!')
      await user.type(confirmInput(), 'DifferentPass12!')
      await user.click(setPassBtn())
    ...
    it('calls confirmNewPassword with the correct email, code, and password', async () => {
      ...
      await user.click(setPassBtn())
      await waitFor(() =>
        expect(mockConfirmNewPassword).toHaveBeenCalledWith('user@example.com', '654321', 'NewPassword12!')
      )
    })
