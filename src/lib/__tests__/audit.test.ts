...
describe('writeAudit', () => {
  ...
  it('gives every action a plain-English label, with no em dashes', () => {
    const actions: AuditAction[] = [
      ...
      'form.publish', 'form.link_created', 'template.upload', 'submission.view', 'submission.export', 'sign.session_started', 'gate_keep.erased', 'gate_keep.protected', 'gate_keep.eol_set',
    ]
